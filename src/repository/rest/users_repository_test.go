...
func TestLoginUserTimeoutFromApi(t *testing.T) {
	...
	rest.AddMockups(&rest.Mock{
		...
		URL:          "https://localhost:8082/users/login",
...
func TestLoginUserInvalidUserJsonResponse(t *testing.T) {
	...
	rest.AddMockups(&rest.Mock{
		...
		RespBody:     `{"id": "1", "first_name": "test", "last_name": "desu", "email": "email@gmail.com"}`,
	})
...
func TestLoginUserNoError(t *testing.T) {
	...
	rest.AddMockups(&rest.Mock{
		...
		RespHTTPCode: http.StatusOK,
		RespBody:     `{"id": 1, "first_name": "test", "last_name": "desu", "email": "email@example.com"}`,
	})
	...
	assert.EqualValues(t, "desu", user.LastName)
	assert.EqualValues(t, "email@example.com", user.Email)
}
